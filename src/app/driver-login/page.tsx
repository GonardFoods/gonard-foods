        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              required
              className="px-4 py-3 text-base outline-none focus:ring-2"
          ...
          <button
            type="submit"
            disabled={loading}
            className="px-8 py-4 font-bold text-sm tracking-widest uppercase transition-opacity hover:opacity-90 disabled:opacity-50"
